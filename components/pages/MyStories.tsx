      ...
      <div className="relative p-2 sm:p-2.5">
          ...
          <div className="mt-3 sm:mt-4 px-1 sm:px-1.5 pb-2 sm:pb-3 pt-1 sm:pt-2">
            ...
            <div className="mt-3 sm:mt-4 flex justify-between items-center">
              <p className="text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-300">{'10 min'}</p>
              <Link href={'/'}><Button  variant={'outline'} className="text-sm sm:text-lg font-bold text-cyan-600 dark:text-primary">view</Button></Link>
            </div>
          </div>
      </div>
    </div>
