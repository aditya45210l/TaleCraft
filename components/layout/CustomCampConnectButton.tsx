...
export function CustomCampConnectButton() {
  ...
  // If the user is not connected with a wallet, show the "Connect Wallet" button
  if (!isConnected) {
    return (
      <Button
        onClick={openModal}
  ...
  // If the user is connected with a wallet but not authenticated with Origin, show "Connect"
  ...
  // If the user is connected and authenticated, show "My Camp"
  return (
    <div>
      {/* CampModal is rendered here without its own button */}
